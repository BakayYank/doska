...
<body id="app">
<header>
    <nav class="navbar navbar-expand-md navbar-light navbar-bson">
        <div class="container">
                    ...
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                @endcan
                                <a class="dropdown-item" href="{{ route('cabinet.home') }}">Капинет пользователя</a>
...
<footer>
    <div class="container">
        <div class="border-top pt-3">
            <p>&copy; {{ date('Y') }}  - Доска объявления</p>
        </div>
    </div>
</footer>
