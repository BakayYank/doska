<div class="search-bar pt-3" style="background: #f5f5f5 !important;">
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <div class="form-group">
                                <input type="text" class="form-control" name="text" value="{{ request('text') }}" placeholder="Поиск объявления...">
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
            ...
            <div class="col-md-3" style="text-align: right">
                <p><a href="{{ route('cabinet.adverts.create') }}" class="btn btn-success"><span class="fa fa-plus"></span> Добавить объявления</a></p>
            </div>
        </div>
    </div>
</div>
