    ...
    <form method="POST" action="{{ route('cabinet.adverts.create.advert.store', [$category, $region]) }}">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body pb-2">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="title" class="col-form-label">Заголовок вашего объявления</label>
                ...
                <div class="form-group">
                    <label for="content" class="col-form-label">Описание</label>
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-primary">Добавить объявления</button>
        </div>
    </form>
